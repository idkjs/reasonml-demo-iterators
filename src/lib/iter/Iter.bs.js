...
function from_labelled_iter(iter, f) {
  return Curry._1(iter, f);
}
...
function persistent(seq) {
  var partial_arg = of_iter_with(seq, (function (param) {
...
function persistent_lazy(seq) {
  ...
  return function (k) {
    ...
    var seq$prime$1 = of_iter_with(seq, k);
...
function head_exn(seq) {
  ...
  if (x !== undefined) {
    ...
    return Pervasives.invalid_arg("Iter.head_exn");
  }
}
...
function rev(seq) {
  var l = of_iter_with(seq, (function (param) {
...
function of_gen(g) {
  ...
  var partial_arg = of_iter_with(iter1, (function (param) {
...
function to_gen(seq) {
  return _to_next(undefined, of_iter_with(seq, (function (param) {
...
function Adapt(X) {
  var to_iter_ = function (set, k) {
    return Curry._2(X.iter, k, set);
  };
  var of_iter_ = function (seq) {
    return fold((function (set, x) {
...
function Make(V) {
  ...
  var of_list = function (l) {
    return of_iter_(function (param) {
                return List.iter(param, l);
              });
  };
  var to_list$1 = function (x) {
    return to_list(to_iter_(x));
  };
  return {
          empty: M.empty,
          is_empty: M.is_empty,
...
function sample(k, seq) {
  var x = head(seq);
  if (x === undefined) {
    return [];
  }
  var a = Caml_array.caml_make_vect(k, Caml_option.valFromOption(x));
  var i = {
    contents: -1
  };
  var f = function (x) {
    ...
    var j = Random.$$int(i.contents);
    if (j < k) {
      return Caml_array.set(a, j, x);
    }
    
  };
  Curry._1(seq, f);
  if (i.contents < k) {
    return $$Array.sub(a, 0, i.contents + 1 | 0);
  } else {
    return a;
  }
}
...
exports.from_labelled_iter = from_labelled_iter;
